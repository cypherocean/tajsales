            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.profile') }}" class="text-muted">Profile</a></li>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.profile.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
