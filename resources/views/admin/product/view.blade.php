                    ...
                    <form name="form" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea type="text" name="product_description" id="product_description" class="form-control" placeholder="Plese enter description" disabled>{{ $data->product_description ?? '' }}</textarea>

                                <span class="kt-form__help error product_description"></span>
                            </div>
                            <div class="form-group col-sm-12">
                                <label for="photo">Image</label>
                                <input type="file" class="dropify disabled" id="photo" name="photo" data-default-file="{{ $data->image ??'' }}" data-allowed-file-extensions="jpg png jpeg" data-max-file-size-preview="2M" disabled>
                        ...
                        <div class="form-group">
                            <a href="{{ route('admin.product.index') }}" class="btn waves-effect waves-light btn-rounded btn-outline-secondary">Back</a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(function() {
        ...
        // CKEDITOR.instances['product_description'].setReadOnly(true);
