...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.product_category.insert') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Plese enter category name" value="{{ @old('name') }}">
