    ...
    <div class="row">
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-right">
                <a class="btn waves-effect waves-light btn-rounded btn-outline-primary pull-right" href="{{ route('admin.counter.create') }}">Add New</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function change_status(object) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{!! route('admin.counter.change.status') !!}",
                    type: "POST",
                    data: {
                        id: id,
                        status: status,
