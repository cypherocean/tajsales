...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.counter.insert') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <input type="number" name="counter_number" max="100000" id="counter_number" class="form-control" placeholder="Plese enter Count here" value="{{ @old('counter_number') }}">
